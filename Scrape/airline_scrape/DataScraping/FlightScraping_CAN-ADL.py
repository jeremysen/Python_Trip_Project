"""
@Description: This file is to scrap flight information (from Guangzhou to Adelaide) from Trip.com
@Author:      Liyuan Gu
@Time:        2019-10-02
"""
import datetime
...
pattern1 = 'https://au.trip.com/flights/guangzhou-to-adelaide/tickets-can-adl/?flighttype=s&dcity=can&acity=adl&startdate='
...
for i in date:
    ...
    workbook = xlsxwriter.Workbook('AirlineData_ADL.xlsx')
