"""
@Description: This file is to scrap flight information (from Guangzhou to Canberra) from Trip.com
@Author:      Liyuan Gu
@Time:        2019-10-02
"""
import numpy as np
...
pattern1 = 'https://au.trip.com/flights/guangzhou-to-canberra/tickets-can-cbr/?flighttype=s&dcity=can&acity=cbr&startdate='
...
for i in date:
    ...
    workbook = xlsxwriter.Workbook('AirlineData_CBR.xlsx')
