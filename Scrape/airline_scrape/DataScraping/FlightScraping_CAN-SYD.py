"""
@Description: This file is to scrap flight information (from Guangzhou to Sydney) from Trip.com
@Author:      Liyuan Gu
@Time:        2019-10-02
"""
import numpy as np
...
pattern1 = 'https://au.trip.com/flights/guangzhou-to-sydney/tickets-can-syd/?flighttype=s&dcity=can&acity=syd&startdate='
...
for i in date:
    ...
    workbook = xlsxwriter.Workbook('AirlineData_SYD.xlsx')
