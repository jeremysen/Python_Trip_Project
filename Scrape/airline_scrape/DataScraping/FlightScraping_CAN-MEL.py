"""
@Description: This file is to scrap flight information (from Guangzhou to Melbourne) from Trip.com
@Author:      Liyuan Gu
@Time:        2019-10-02
"""
import numpy as np
...
'''
Scrape Guangzhou to  flight data from Trip.com
'''
...
pattern1 = 'https://au.trip.com/flights/guangzhou-to-melbourne/tickets-can-mel/?flighttype=s&dcity=can&acity=mel&startdate='
...
for i in date:
    ...
    workbook = xlsxwriter.Workbook('AirlineData_MEL_test.xlsx')
